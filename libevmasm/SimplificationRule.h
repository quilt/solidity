...
struct EVMBuiltins
{
	...
	static auto constexpr AUTHORIZE = PatternGenerator<Instruction::AUTHORIZE>{};
	static auto constexpr AUTHORIZEDCALL = PatternGenerator<Instruction::AUTHORIZEDCALL>{};
